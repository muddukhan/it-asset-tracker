...
export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'updateLocalUser' : IDL.Func([IDL.Nat, LocalUserInput], [], []),
    'updateSoftware' : IDL.Func([IDL.Nat, StoreSoftwareInput], [], []),
    'addAssetWithCreds' : IDL.Func([IDL.Text, IDL.Text, AssetInput], [IDL.Nat], []),
    'updateAssetWithCreds' : IDL.Func([IDL.Text, IDL.Text, IDL.Nat, AssetInput], [], []),
    'deleteAssetWithCreds' : IDL.Func([IDL.Text, IDL.Text, IDL.Nat], [], []),
    'addSoftwareWithCreds' : IDL.Func([IDL.Text, IDL.Text, StoreSoftwareInput], [IDL.Nat], []),
    'updateSoftwareWithCreds' : IDL.Func([IDL.Text, IDL.Text, IDL.Nat, StoreSoftwareInput], [], []),
    ...
    'createFirstLocalUser' : IDL.Func([LocalUserInput], [IDL.Variant({'ok': IDL.Nat, 'err': IDL.Text})], []),
