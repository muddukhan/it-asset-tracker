...
export function AdminPage() {
  ...
  const [selfAdminPending, setSelfAdminPending] = useState(false);
  ...
  const handleMakeMeAdmin = async () => {
    if (!myPrincipal) {
      toast.error("Please sign in first to get your principal ID");
      return;
    }
    let principal: Principal;
    try {
      ...
      toast.error("Could not read your principal ID");
      return;
    }
    setSelfAdminPending(true);
    try {
      await assignRole.mutateAsync({ user: principal, role: UserRole.admin });
      toast.success("You are now an admin! Refreshing access…");
    } catch {
      toast.error("Failed to assign admin role");
    } finally {
      setSelfAdminPending(false);
    }
  };
      ...
      >
        ...
        >
          ...
          <Button
            ...
            disabled={selfAdminPending || !myPrincipal}
            className="w-full"
            style={{
          ...
          >
            ...
            {selfAdminPending ? "Assigning…" : "Make Me Admin"}
          </Button>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                Tip: Click &quot;Make Me Admin&quot; above to quickly grant
