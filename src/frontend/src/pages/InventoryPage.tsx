        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value={AssetStatus.inStorage}>In Storage</SelectItem>
                ...
                <TableBody>
                  {paginated.map((asset, i) => (
                    <TableRow
                      ...
                      data-ocid={`inventory.item.${(page - 1) * PAGE_SIZE + i + 1}`}
                        ...
                        >
                          <div className="flex items-center justify-end gap-1">
                            <Button
                              ...
                              data-ocid={`inventory.edit_button.${(page - 1) * PAGE_SIZE + i + 1}`}
                            >
                            ...
                            <Button
                              ...
                              data-ocid={`inventory.delete_button.${(page - 1) * PAGE_SIZE + i + 1}`}
                            >
